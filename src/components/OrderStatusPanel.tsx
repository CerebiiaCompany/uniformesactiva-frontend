              ...
              <div className="grid grid-cols-2 gap-3">
                <div className="flex items-center gap-2 rounded-lg border border-border bg-muted/30 p-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm font-medium text-foreground">{order.cliente_id.slice(0, 8)}</p>
                  </div>
                </div>
                <div className="flex items-center gap-2 rounded-lg border border-border bg-muted/30 p-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm font-medium text-foreground">{order.fecha_creacion.slice(0, 10)}</p>
                  </div>
                </div>
              </div>
                  ...
                  <div key={step.key} className="relative flex gap-4">
                    ...
                    <div className={cn("flex-1 pb-8", isLast && "pb-0")}>
                      <div className={cn("rounded-lg border p-4", isCurrent && "border-primary/50 bg-primary/10")}>
                        ...
                        {isNext && (
                          <Button size="sm" onClick={handleAdvance} className="mt-3 gap-1.5">
