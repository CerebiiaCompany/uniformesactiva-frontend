...
import { AlertTriangle, Database, History, Layers, PackageX, Pencil, Plus, Trash2, X } from "lucide-react";
...
export default function Inventory() {
  const [activeTab, setActiveTab] = useState<"tns" | "tns-ventas" | "local">("tns");
  ...
  return (
    <AppLayout
      ...
      subtitle={
        activeTab === "tns"
          ? "Consulta en tiempo real del inventario transaccional sincronizado con el ERP TNS."
          : activeTab === "tns-ventas"
          ? "Reporte detallado de ventas, clientes y facturas sincronizadas desde el ERP TNS."
          : "Insumos y telas (por referencia). El stock se descuenta al pasar una orden a producción."
      }
      eyebrow="Operación"
    >
      <div className="space-y-6">
        {/* Selector de Pestañas de Inventario */}
        <div className="flex items-center gap-2 border-b border-border pb-px overflow-x-auto">
          <button
            type="button"
            onClick={() => setActiveTab("tns")}
            className={cn(
          ...
          >
            ...
            <span>Inventario TNS (ERP en Vivo)</span>
          ...
          <button
            type="button"
            onClick={() => setActiveTab("tns-ventas")}
            className={cn(
              "flex items-center gap-2 px-4 py-2.5 text-sm font-semibold border-b-2 -mb-px transition-all rounded-t-lg shrink-0",
              activeTab === "tns-ventas"
                ? "border-red-600 text-red-600 dark:text-red-500 bg-red-50/30 dark:bg-red-950/20"
          ...
          >
            ...
            <span>Insumos y Telas Internos</span>
        ...
        {/* Contenido de la pestaña TNS Inventario */}
        {activeTab === "tns" && <TNSInventarioTab />}

        {/* Contenido de la pestaña TNS Ventas Detalladas */}
        {activeTab === "tns-ventas" && <TNSVentasDetalladasTab />}

        {/* Contenido de la pestaña Insumos Locales */}
        {activeTab === "local" && (
          <div className="space-y-6">
