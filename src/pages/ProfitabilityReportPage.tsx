    ...
    try {
      await printReportDocument({
        ...
        columns: [
          ...
          { key: "costo", label: "Costo est.", align: "right" },
          { key: "venta", label: "Venta", align: "right" },
          { key: "utilidad", label: "Utilidad", align: "right" },
          { key: "margen", label: "Margen", align: "right" },
          { key: "costo_unid", label: "Costo/unid.", align: "right" },
          { key: "venta_unid", label: "Venta/unid.", align: "right" },
        ],
        rows: rows.map((r) => [
          r.codigo,
          r.cliente,
          ...
          fmtMoney(r.venta),
          fmtMoney(r.utilidad),
          `${r.margen_pct.toLocaleString("es-CO", {
            minimumFractionDigits: 1,
            maximumFractionDigits: 1,
          })}%`,
          fmtUnit(r.costo_unitario),
          fmtUnit(r.venta_unitario),
        ]),
        notes:
          "Los valores provienen del costeo registrado en cada orden. El margen se calcula como utilidad / venta.",
